...
export const API_socket = 'wss://9p1on307u0.execute-api.us-east-1.amazonaws.com/dev'; //'wss://{apiid}.execute-api.{region}.amazonaws.com/dev';
export const API_http = 'https://pia1630436.execute-api.us-east-1.amazonaws.com'; //'https://{apiid}.execute-api.{region}.amazonaws.com';
